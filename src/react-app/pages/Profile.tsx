...
import { User, Mail, Phone, Calendar, Edit2, Check, X, Upload, Shield } from 'lucide-react';
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-purple-200">{user.email || user.phone}</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-white/60">Verify your phone number</p>
                </div>
                {user.is_phone_verified ? (
                  <span className="px-3 py-1 bg-green-600 text-white text-sm rounded-full">
                    Verified ✓
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                ...
                <p className="text-sm text-red-300/80 mb-3">This action cannot be undone</p>
